...
function egal(){
	...
	var x = document.getElementById("ecran").value;
	
	switch(operator){
		case "+":
		document.getElementById("ecran").value = addition(parseInt(totale),parseInt(x));
		totale=document.getElementById("ecran").value
		break;
		case "-":
		document.getElementById("ecran").value = soustraction(parseInt(totale),parseInt(x));
		totale=document.getElementById("ecran").value
		break;
		case "*":
		document.getElementById("ecran").value = multiplication(parseInt(totale),parseInt(x));
		totale=document.getElementById("ecran").value
		break;
		case "/":
		document.getElementById("ecran").value = division(parseInt(totale),parseInt(x));
		totale=document.getElementById("ecran").value
		break;
	}
